...
const TopContributors = () => {
  ...
  return (
    <section className="w-full bg-slate-50 dark:bg-slate-900 py-16 md:py-20 border-t border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-200 transition-colors duration-300">
      ...
      <div className="w-11/12 max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {contributors.map((user) => (
            <div
              key={user.id}
              className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl flex items-center space-x-4 transition-all duration-300 hover:shadow-xl hover:border-[#006eff]/20 dark:hover:border-[#006eff]/40 dark:hover:bg-slate-900"
            >
