...
const TrendingIdeas = async () => {
  ...
  return (
    <section className="w-full bg-white dark:bg-slate-950 py-16 text-slate-800 dark:text-slate-200 transition-colors duration-300">
      <div className="w-11/12 max-w-7xl mx-auto space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-500 dark:text-slate-400 max-w-xl text-sm md:text-base">
