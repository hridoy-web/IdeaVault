...
const LoginPage = () => {
  const handleLogin = (e) => {
    ...
    //Auth integration + JWT Token setup + Toast
  };
    ...
    <div className="w-full bg-slate-50 min-h-screen flex items-center justify-center py-12 text-slate-800">
      <div className="w-11/12 max-w-md bg-white border border-slate-200 p-6 md:p-10 rounded-3xl shadow-sm space-y-6">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button 
            type="submit" 
            className="btn bg-gradient-to-r from-[#006eff] to-indigo-600 hover:from-[#005fd8] hover:to-indigo-700 text-white border-none w-full font-bold text-xs uppercase tracking-wider rounded-xl py-3.5 h-auto min-h-0 mt-2 transition-all shadow-md shadow-blue-500/10"
          >
            Sign In
          </button>
        </form>
